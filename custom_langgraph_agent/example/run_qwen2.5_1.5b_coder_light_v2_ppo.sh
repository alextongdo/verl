#!/usr/bin/env bash
#SBATCH --job-name=rl-langgraph-1p5b-coder-light-v2-ppo
...
model_path=${model_path:-$DATA_ROOT/model/Qwen2.5-Coder-1.5B-Instruct}
...
experiment_name=qwen2.5-1.5b-coder-light-v2-ppo
...
critic_max_token_len_per_gpu=$(( actor_max_token_len_per_gpu * 2 ))
